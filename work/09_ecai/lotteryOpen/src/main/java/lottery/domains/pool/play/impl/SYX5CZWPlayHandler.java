 ...
 * 
 */
public class SYX5CZWPlayHandler implements ITicketPlayHandler {
...
//		String[] nums = betNums.trim().split(",");
	...
	public String[] getOpenNums(String openNums) {
		return TicketPlayUtils.sortByDescGetOpenNums(openNums, offsets);
	}
	@Override
	...
	public static void main(String[] args) {
		// BDWPlayHandler cqssc_bdwwx2m = new BDWPlayHandler("cqssc_bdwwx2m", 2, ITicketPlayHandler.OFFSETS_WUXIN);
		...
		// BDWPlayHandler cqssc_bdwwx3m = new BDWPlayHandler("cqssc_bdwwx3m", 3, ITicketPlayHandler.OFFSETS_WUXIN);
		// WinResult winResult = cqssc_bdwwx3m.calculateWinNum(1, "0,1,2,3,4,5,6,7", "7,3,2,0,1"); // 732 731 721 321
		// System.out.println(winResult.getWinNum());

		// BDWPlayHandler cqssc_bdwsix2mq = new BDWPlayHandler("cqssc_bdwsix2mq", 2, ITicketPlayHandler.OFFSETS_QIANSI);
		// WinResult winResult = cqssc_bdwsix2mq.calculateWinNum(1, "0,1,2,3,4,5,6,7", "6,7,6,0,5"); // 67 60 70
		// System.out.println(winResult.getWinNum());

		SYX5CZWPlayHandler sd11x5_czw = new SYX5CZWPlayHandler("sd11x5_czw", 1, ITicketPlayHandler.OFFSET_11X5ZHONG);
		WinResult winResult = sd11x5_czw.calculateWinNum(1, "01,02,03,04,05,06,07,08", "10,01,02,08,04");
		System.out.println(winResult.getWinNum());
	}
}
