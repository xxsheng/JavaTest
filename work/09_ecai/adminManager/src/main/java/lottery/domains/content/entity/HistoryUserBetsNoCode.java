...
@Entity
@Table(name = "user_bets", catalog = Database.backup)
public class HistoryUserBetsNoCode implements java.io.Serializable, Cloneable {
	...
	public HistoryUserBets formatBean() {
		HistoryUserBets entity = new HistoryUserBets();
