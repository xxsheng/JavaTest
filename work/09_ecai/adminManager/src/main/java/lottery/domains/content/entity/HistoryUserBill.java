 ...
 */
@Entity
@Table(name = "user_bill", catalog = Database.backup, uniqueConstraints = @UniqueConstraint(columnNames = "billno"))
public class HistoryUserBill implements java.io.Serializable {
	...
	/** minimal constructor */
	public HistoryUserBill(String billno, int userId, int account,
