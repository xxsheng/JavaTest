 ...
 */
@Entity
@Table(name = "user_bets", catalog = Database.backup, uniqueConstraints = @UniqueConstraint(columnNames = {
		"billno", "user_id" }))
public class HistoryUserBets implements java.io.Serializable, Cloneable {
	...
	/** minimal constructor */
	public HistoryUserBets(String billno, int userId, int type,
	...
	public HistoryUserBets(String billno, int userId, int type,
			...
			int nums, String model, int multiple, int code,
			double point, double money, String time, String stopTime,
			String openTime, int status, int isAll, int locked) {
		this.billno = billno;
		this.userId = userId;
		this.type = type;
		this.lotteryId = lotteryId;
	...
	public HistoryUserBets(String billno, int userId, int type,
			...
			Integer chaseStop, String planBillno, Double rewardMoney, int isAll, int locked) {
		this.billno = billno;
		this.userId = userId;
		this.type = type;
		this.lotteryId = lotteryId;
