...
//			log.error("秒卡通代付失败,remarks长度超过200");
//			json.set(2, "2-4005");
//			return null;
//		}
...
//		String sign = kvs.sign(PayConfig.MKT.MD5_SECRET, "UTF-8");
...
//			log.debug("秒卡通代付请求返回{}", retStr);
//		} catch (Exception e) {
//			log.error("秒卡通代付请求失败，发生连接异常", e);
//			json.set(2, "2-4001");
//			return null;
//		}
//
//		if (StringUtils.isEmpty(retStr)) {
//			log.error("秒卡通代付请求失败，发送请求后返回空数据");
//			json.set(2, "2-4006");
//			return null;
//		}
//
...
//			log.error("秒卡通代付请求失败，解析返回数据失败，返回数据为：" + retStr);
...
//		String serverRetSign = kvs.sign(PayConfig.MKT.MD5_SECRET, "UTF-8");
//
//		// 代付和代付查询接口，先加密一次，结果转大写在加密两次（两次加密都不用转大写）
...
//			log.error("秒卡通代付请求成功，但返回空订单号：" + retStr);
//			json.set(2, "2-4014");
//			return null;
//		}
//
//		if (!serverRetSign.equals(retSign)) {
//			log.error("秒卡通代付请求成功，返回数据验签不对，服务器验签：" + serverRetSign+"，返回数据为：" + retStr);
//			json.set(2, "2-4008");
//			return order_id;
//		}
//
...
//			log.error("秒卡通代付请求成功，但银行未处理:" + retStr);
//			json.set(2, "2-4009");
//			return order_id;
//		}
//		if ("3".equals(bank_status)) {
//			log.error("秒卡通代付请求成功，但银行处理失败:" + retStr);
//			json.set(2, "2-4010");
//			return order_id;
//		}
//
//		log.error("秒卡通代付请求成功，出现未知银行状态:" + retStr);
