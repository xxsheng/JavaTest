...
//
// @Component
// public class LecaiCrawlerBJC {
//
// 	private static final Logger logger = LoggerFactory.getLogger(LecaiCrawlerBJC.class);
//
// 	@Autowired
...
// 			// 设置数据来源
// 			lotteryOpenCode.setRemarks("baidu.lecai.com");
...
// 		switch (lotteryName) {
// 		case "bjkl8":
// 			return LecaiCrawlerUtil.getBjkl8OpenCode(lotteryName, date);
// 		case "bjpk10":
// 			return LecaiCrawlerUtil.getBjpk10OpenCode(lotteryName, date);
// 		default:
// 			return null;
// 		}
// 	}
